...
export function validatePlayerGameLogEntryShape(
  ...
  if ('mlbRole' in e && e.mlbRole != null && !['batter', 'pitcher'].includes(e.mlbRole as string)) {
    errors.push(`field "mlbRole": expected 'batter' | 'pitcher' | null, got ${describe(e.mlbRole)}`);
  }
  if (
    'nhlPosition' in e &&
    e.nhlPosition != null &&
    ...
    errors.push(`field "nhlPosition": expected 'skater' | 'goalie' | null, got ${describe(e.nhlPosition)}`);
  }
  if ('mlbExtras' in e && e.mlbExtras != null && (typeof e.mlbExtras !== 'object' || Array.isArray(e.mlbExtras))) {
    errors.push(`field "mlbExtras": expected object or undefined, got ${describe(e.mlbExtras)}`);
  }
  if ('categories' in e && e.categories != null && (typeof e.categories !== 'object' || Array.isArray(e.categories))) {
